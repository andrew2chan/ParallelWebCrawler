...
public final class CrawlingTaskFactory {
    private Clock clock;
    ...
    public CrawlingTaskFactory(Instant deadline, Map<String, Integer> counts, Set<String> visitedUrls, Clock clock, List<Pattern> ignoredUrls, PageParserFactory parserFactory) {
